 ...
 *
 * You cannot access the mountain array directly. You may only access the array using a leetcode.MountainArray interface:
 * leetcode.MountainArray.get(k) returns the element of the array at index k (0-indexed).
 * leetcode.MountainArray.length() returns the length of the array.
 * Submissions making more than 100 calls to leetcode.MountainArray.get will be judged Wrong Answer. Also, any solutions that attempt to circumvent the judge will result in disqualification.
 *
 * Example 1:
 *
